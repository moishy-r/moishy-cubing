// Solver worker for the /apb-demo page.
//
// The solve is a long synchronous search — on the main thread it froze the tab
// for as long as it ran (seconds, and well over ten with `direct` enabled). Here
...
self.addEventListener("message", async (ev) => {
  ...
  try {
    ...
    const result = await apb.solve(scramble, full, opts ?? {});
